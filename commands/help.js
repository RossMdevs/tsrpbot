module.exports = {
  ...
  execute(message, args) {
    ...
    ○ **!request <details>** - Streamlines a request to the Board of Directors (SIT+)
    ○ **!report <details>** - Report an issue or user (Anyone can use this command)
    ○ **!role add/remove <user_id/user_mention/username> @role** - Add or remove roles for a user (HA+)`;
